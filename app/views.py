...
def search(request):
    """
    This function renders the search.html page with the relevant data
    after the user submits a form with the city's name
    """
    if request.method == 'POST':
    ...
    # if the request is not a POST request, return the base HTML page
